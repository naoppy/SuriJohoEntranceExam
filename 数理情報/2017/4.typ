...
また、$X(0)^⊤ = X_0^⊤ = X_0$より、微分方程式の回の一意性から$X(t) = X(t)^⊤$で$X(t)$は対称である。
...
$Q(t)$が直交行列であることから、
  $
    ...
    &= matrixdet(Q(t)) matrixdet(lambda I - X(t)) matrixdet(Q(t)^⊤)\
    &= matrixdet(lambda I - X(t))
  $
...
任意の$k=1,2,...$に対して、
  ...
  $
$D_k$は対称かつ歪対称なので$D_k=0$である。したがって$Q_k^⊤ Q_k = Q_0^⊤ Q_0 = I$であり$Q_k$は直交行列である。\
したがって、
  $
